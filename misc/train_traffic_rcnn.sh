...
./train_traffic_net.py --solver models/ZF_end2end/solver.prototxt --imdb traffic_train --run-name zf --cfg cfgs/faster_rcnn_end2end.yml --iters 70000 --weights /mnt/nvme/py-faster-rcnn/data/imagenet_models/ZF.v2.caffemodel
