...
def parse_args():
    ...
    parser.add_argument('--gpu', dest='gpu_id',
                        ...
                        default=0, type=int)
    parser.add_argument('--net-name', dest='net_name',
                        help='Network name (e.g. VGG16_alt_opt)',
                        default="VGG16_alt_opt", type=str)
...
def get_solvers(net_name):
    ...
    solvers = [[net_name, 'stage1_rpn_solver60k80k.pt'],
               [net_name, 'stage1_fast_rcnn_solver30k40k.pt'],
               [net_name, 'stage2_rpn_solver60k80k.pt'],
               [net_name, 'stage2_fast_rcnn_solver30k40k.pt']]
    ...
    rpn_test_prototxt = os.path.join(
        cfg.MODELS_DIR, net_name, 'rpn_test.pt')
...
def train_rpn(queue=None, imdb_name=None, init_model=None, solver=None,
    ...
    # TODO: Check if combined_roidb is needed
